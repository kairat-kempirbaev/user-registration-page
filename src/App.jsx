...
function App() {
  return (
    <div className="min-h-screen flex p-6 pt-20  flex-col gap-12 md:gap-0 md:flex-row md:justify-around md:item-center bg-[#ffa2a2] bg-center bg-no-repeat bg-[url('images/bg-intro-mobile.png')] md:bg-[url('images/bg-intro-desktop.png')]">
